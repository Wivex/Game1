...
namespace Game1
{
    ...
    /// - Load a loading screen, which will transition on at the same time.
    ...
    {
        public bool LoadingIsSlow { get; }
        public bool OtherScreensAreGone { get; set; }
        public GameScreen[] ScreensToLoad { get; }
